...
public class EntityMinivox extends EntityAnimal
{
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityMinivox.class);
    }
    ...
    public EntityMinivox createChild(EntityAgeable ageable)
    {
        return new EntityMinivox(this.worldObj);
    }
